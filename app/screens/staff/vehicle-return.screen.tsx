    ...
    return (
        <View style={styles.container}>
            ...
            <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
                ...
                {/* Description Input */}
                <NotesSection
                    title={isAlreadyCheckedOut ? "Return Notes" : "Return Notes (Optional)"}
                    value={description}
                ...
                <ImageGallerySection
                    title={isAlreadyCheckedOut ? "Return Photos (Already Submitted)" : `Return Photos (${selectedImages.length}/5)`}
                    images={isAlreadyCheckedOut && existingCheckOutData ? existingCheckOutData.images : selectedImages}
