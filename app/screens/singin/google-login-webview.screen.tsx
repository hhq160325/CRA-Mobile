...
const GoogleLoginWebView = () => {
    ...
    const handleNavigationStateChange = (navState: any) => {
        ...
        // Check if we got redirected to callback URL or got token in URL
        if (url.includes("/callback") || url.includes("jwtToken") || url.includes("token=")) {
            console.log("✅ Callback detected in WebView")

            try {
                // Parse URL (handle both http and carapp:// schemes)
                const parsedUrl = new URL(url.replace("carapp://", "https://dummy.com/"))
                ...
                // Try hash params if not in query
                ...
                if (jwtToken) {
                    ...
                    if (typeof localStorage !== "undefined" && localStorage?.setItem) {
                        ...
                        // Decode JWT to create user object
                        try {
    ...
    // Inject JavaScript to intercept responses and detect tokens
