...
export default function FeedbackListScreen() {
    ...
    // Filter by rating only (status filtering removed as API doesn't support it)
        ...
        <View style={{ flex: 1, backgroundColor: colors.background }}>
            ...
            {isLoading ? (
                <View style={{ flex: 1, justifyContent: "center", alignItems: "center" }}>
                    ...
                    <Text style={{ marginTop: verticalScale(12), color: colors.placeholder }}>
                        Loading feedback...
                    </Text>
                </View>
            ) : error ? (
                <View style={{ flex: 1, justifyContent: "center", alignItems: "center", padding: scale(16) }}>
                    <Icon name="error-outline" size={scale(48)} color={colors.destructive} />
                    <Text style={{ marginTop: verticalScale(12), color: colors.destructive, textAlign: "center" }}>
                        {error}
                    </Text>
                    <Pressable
                        onPress={loadFeedback}
