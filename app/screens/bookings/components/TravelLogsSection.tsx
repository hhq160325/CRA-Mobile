...
import { carTravelLogService, getAllTollBooths } from '../../../../lib/api/services/carTravelLog.service';
import type { CarTravelLog, TollBooth } from '../../../../lib/api/services/carTravelLog.service';
    ...
    const loadTollBooths = async () => {
        ...
        try {
            ...
            if (result.data) {
                ...
                console.log('BookingDetail TravelLogs: Toll booths loaded:', result.data.map(booth => `ID: ${booth.id}, Name: ${booth.name}`));
            } else if (result.error) {
                console.error('BookingDetail TravelLogs: Error loading toll booths:', result.error);
            }
        } catch (error) {
            console.error('BookingDetail TravelLogs: Exception loading toll booths:', error);
        } finally {
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.summary}>
                ...
                <View style={styles.summaryItem}>
                    <Text style={styles.summaryLabel}>Toll Booths Passed</Text>
